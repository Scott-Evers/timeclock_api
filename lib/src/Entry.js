import {getWeekStart} from './util.js';

class Entry {
  constructor(id, status, taskId, offset, weekStartsOn, hours, comment, monday, tuesday, wednesday, thursday, friday, saturday, sunday) {
      this.EntryId = id ? id : '';
